...
- Split frontend runtime, clock, round rendering, validator rendering, validator type/source helpers, map rendering, and formatting helpers into smaller files.
...
2. Review map data and popup modules:
